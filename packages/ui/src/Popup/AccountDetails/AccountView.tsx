    ...
    <>
      ...
      <Box mb="s" mx="m">
        <Flex justifyContent="space-between" mb="s">
          <Box>
            <Text color="gray3" variant="b2m">
              CDD Verification
            </Text>
          </Box>
          <Box>
            {selectedAccount?.did ? (
              <CddStatus cdd={selectedAccount?.cdd} withText />
            ) : (
              'N/A'
            )}
          </Box>
      ...
      <Flex justifyContent="space-between" mx="m">
        <InitialsAvatar name={selectedAccount?.name} />
        <Box ml="s" width="100%">
          <Flex flexDirection="row">
            <TextOverflowEllipsis color="gray.1" maxWidth="157px" variant="b2m">
