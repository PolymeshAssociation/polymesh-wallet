...
export interface PolyRequestSignatures extends DotRequestSignatures {
  ...
  'poly:pri(customNetworkUrl.subscribe)': [ RequestPolyCustomNetworkUrlSubscribe, boolean, string ];
...
export declare type PolySubscriptionMessageTypes = NoUndefinedValues<{ [MessageType in keyof PolyRequestSignatures]: PolyRequestSignatures[MessageType][2];}>;
...
export declare type PolyResponseTypes = { [MessageType in keyof PolyRequestSignatures]: PolyRequestSignatures[MessageType][1];};
...
export type PolyTransportResponseMessage< TMessageType extends PolyMessageTypes> = TMessageType extends PolyMessageTypesWithNoSubscriptions ? PolyTransportResponseMessageNoSub<TMessageType> : TMessageType extends PolyMessageTypesWithSubscriptions ? PolyTransportResponseMessageSub<TMessageType> : never;
