...
export async function requestSigning (
  ...
  const request: SignerPayloadJSON = {
    address,
    blockHash:
      '0xa9195303fe7e5d25c22943bc6205daa217e6d04ca9ef5938909fc50dc4fc906a',
    blockNumber: '0x0038e185',
    era: '0x5500',
    genesisHash:
      '0x56fb854a431370af86de89a0003ca3eb500066ee66eb01a92810369b3dc435c3', // PME
    method:
      '0x0400ff549b9c93a68c946441854b286f843d6413b54eb490fe2940888bb4203cadb65600',
    nonce: '0x00000000',
    signedExtensions: [
      'CheckSpecVersion',
      'CheckTxVersion',
